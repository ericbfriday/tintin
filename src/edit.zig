...
pub const create_node_list = tintin_c.create_node_list;
pub const cursor_clear_line = tintin_c.cursor_clear_line;
pub const cursor_redraw_edit = tintin_c.cursor_redraw_edit;
...
pub const fputs = tintin_c.fputs;
...
pub const inputline_set = tintin_c.inputline_set;
pub const off_t = tintin_c.off_t;
pub const pcre2_code_8 = tintin_c.pcre2_code_8;
pub const putc = tintin_c.putc;
...
pub export fn do_edit(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8, arg_arg3: [*c]u8, arg_arg4: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    if (@as(c_int, arg1.*) == @as(c_int, 0)) {
        tintin_header(ses, 80, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(" EDIT OPTIONS "))))))), .{});
        {
            cnt = 0;
            while (edit_table[@bitCast(@as(isize, @intCast(cnt)))].fun != null) : (cnt += 1) {
                if (@as(c_int, edit_table[@bitCast(@as(isize, @intCast(cnt)))].desc.*) != 0) {
                    tintin_printf2(ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("  [%-18s] %s"))))))), .{edit_table[@bitCast(@as(isize, @intCast(cnt)))].name, edit_table[@bitCast(@as(isize, @intCast(cnt)))].desc});
                }
            }
        }
    ...
    } else {
        {
            cnt = 0;
            while (edit_table[@bitCast(@as(isize, @intCast(cnt)))].fun != null) : (cnt += 1) {
                if (is_abbrev(arg1, edit_table[@bitCast(@as(isize, @intCast(cnt)))].name) != 0) {
                    _ = edit_table[@bitCast(@as(isize, @intCast(cnt)))].fun.?(ses, arg, arg1, arg2);
                    return ses;
                }
            }
        }
        show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#ERROR: #EDIT {%s} IS NOT A VALID OPTION."))))))), .{arg1});
    }
    return ses;
}
pub export fn edit_create(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    _ = &edit;
    var pta: [*c]u8 = undefined;
    _ = &pta;
    var ptn: [*c]u8 = undefined;
    _ = &ptn;
    var index_1: c_int = undefined;
    _ = &index_1;
    clear_editor(edit);
    arg = sub_arg_in_braces(ses, arg, arg1, GET_ONE, (@as(c_int, 1) << @intCast(@as(c_int, 4))) | (@as(c_int, 1) << @intCast(@as(c_int, 5))));
    _ = str_cpy(&gtd.*.ses.*.input.*.edit_name, arg1);
    index_1 = 0;
    ...
    show_message(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#EDIT CREATE: CREATED %d LINES."))))))), .{edit.*.used});
    enable_editor(edit);
    return ses;
}
pub export fn edit_load(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    if (@as(?*anyopaque, @ptrCast(@alignCast(blk: {
        const tmp = search_nest_node_ses(ses, arg1);
        node = tmp;
        break :blk tmp;
    }))) == @as(?*anyopaque, null)) {
        show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#EDIT LOAD: VARIABLE {%s} NOT FOUND."))))))), .{arg1});
        return ses;
    }
    ...
    {
        index_1 = 0;
        while (index_1 < node.*.root.*.used) : (index_1 += 1) {
            _ = substitute(ses, @as([*c][*c]struct_listnode, @ptrCast(&node.*.root.*.list))[@bitCast(@as(isize, @intCast(index_1)))].*.arg1, arg2, @as(c_int, 1) << @intCast(@as(c_int, 7)));
            insert_line(edit, index_1, arg2);
        }
    }
    show_message(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#EDIT LOAD: LOADED %d LINES FROM {%s}."))))))), .{edit.*.used, arg1});
    enable_editor(edit);
    return ses;
}
pub export fn edit_read(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    arg = sub_arg_in_braces(ses, arg, arg1, GET_ONE, (@as(c_int, 1) << @intCast(@as(c_int, 4))) | (@as(c_int, 1) << @intCast(@as(c_int, 5))));
    if (@as(c_int, arg1.*) == @as(c_int, 0)) {
        show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#SYNTAX: #EDIT READ <FILENAME>"))))))), .{});
        return ses;
    }
    if (@as(?*anyopaque, @ptrCast(@alignCast(blk: {
        ...
        show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#ERROR: #EDIT READ: FILE {%s} NOT FOUND."))))))), .{arg1});
        return ses;
    }
    clear_editor(edit);
    _ = str_cpy(&gtd.*.ses.*.input.*.edit_name, arg1);
    ...
    show_message(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#EDIT READ: READ %d LINES FROM {%s}."))))))), .{edit.*.used, arg1});
    enable_editor(edit);
    _ = fclose(file);
    return ses;
}
pub export fn edit_resume(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    if (edit.*.size == edit.*.update) {
        insert_line(edit, edit.*.update, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
    }
    inputline_set(edit.*.line[@bitCast(@as(isize, @intCast(edit.*.update)))].*.str, 0);
    _ = check_all_events(gtd.*.ses, @as(c_int, 1) << @intCast(@as(c_int, 6)), 0, 1, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("EDIT RESUMED"))))))), .{gtd.*.ses.*.input.*.edit_name});
    cursor_redraw_edit(ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
    return ses;
}
pub export fn edit_save(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    if (!(valid_variable(ses, arg1) != 0)) {
        show_error(ses, LIST_VARIABLE, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#EDIT SAVE: INVALID VARIABLE NAME {%s}."))))))), .{arg1});
        return ses;
    }
    node = set_nest_node_ses(ses, arg1, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))), .{});
    node.*.root = init_list(gtd.*.ses, LIST_VARIABLE, LIST_SIZE);
    {
        index_1 = 0;
        while (index_1 < edit.*.used) : (index_1 += 1) {
            _ = substitute(ses, edit.*.line[@bitCast(@as(isize, @intCast(index_1)))].*.str, arg2, @as(c_int, 1) << @intCast(@as(c_int, 1)));
            _ = create_node_list(node.*.root, ntos(index_1), arg2, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))), @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
        }
    }
    show_message(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#EDIT SAVE: SAVED %d LINES TO {%s}."))))))), .{edit.*.used, arg1});
    return ses;
}
pub export fn edit_suspend(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    var edit: [*c]struct_edit_data = gtd.*.ses.*.input.*.edit;
    _ = &edit;
    if (!((gtd.*.ses.*.input.*.flags & (@as(c_int, 1) << @intCast(@as(c_int, 0)))) != 0)) {
        tintin_printf2(gtd.*.ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("edit_suspend: not currently editing"))))))), .{});
        return ses;
    }
    gtd.*.ses.*.input.*.flags &= ~(@as(c_int, 1) << @intCast(@as(c_int, 0)));
    _ = str_cpy(&edit.*.line[@bitCast(@as(isize, @intCast(edit.*.update)))].*.str, gtd.*.ses.*.input.*.buf);
    cursor_clear_line(ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
    cursor_redraw_edit(ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
    _ = check_all_events(gtd.*.ses, @as(c_int, 1) << @intCast(@as(c_int, 6)), 0, 1, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("EDIT SUSPENDED"))))))), .{gtd.*.ses.*.input.*.edit_name});
    return ses;
}
pub export fn edit_write(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    arg = sub_arg_in_braces(ses, arg, arg1, GET_ONE, (@as(c_int, 1) << @intCast(@as(c_int, 4))) | (@as(c_int, 1) << @intCast(@as(c_int, 5))));
    if (@as(c_int, arg1.*) == @as(c_int, 0)) {
        _ = str_cpy(&arg1, gtd.*.ses.*.input.*.edit_name);
    }
    if (@as(?*anyopaque, @ptrCast(@alignCast(blk: {
        ...
        show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#ERROR: #EDIT WRITE: COULDN'T OPEN {%s} TO WRITE."))))))), .{arg1});
        return ses;
    }
    {
        index_1 = 0;
        while (index_1 < edit.*.used) : (index_1 += 1) {
            _ = fputs(edit.*.line[@bitCast(@as(isize, @intCast(index_1)))].*.str, file);
            _ = putc(ASCII_LF, file);
        }
    }
    show_message(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#EDIT WRITE: WROTE %d LINES TO {%s}."))))))), .{index_1, arg1});
    return ses;
}
pub export fn create_editor() [*c]struct_edit_data {
    return @ptrCast(@alignCast(calloc(1, @sizeOf(struct_edit_data))));
}
pub export fn enable_editor(arg_edit: [*c]struct_edit_data) void {
    var edit = arg_edit;
    _ = &edit;
    var str1: [*c]u8 = undefined;
    _ = &str1;
    var filesize: c_int = undefined;
    _ = &filesize;
    gtd.*.ses.*.input.*.flags |= @as(c_int, 1) << @intCast(@as(c_int, 0));
    if (edit.*.used == @as(c_int, 0)) {
        create_line(edit, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
    }
    inputline_set(edit.*.line[@bitCast(@as(isize, @intCast(edit.*.update)))].*.str, 0);
    str1 = str_alloc_stack(0);
    filesize = str_save_editor(gtd.*.ses.*.input.*.edit, &str1);
    _ = check_all_events(gtd.*.ses, @as(c_int, 1) << @intCast(@as(c_int, 6)), 0, 4, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("EDIT STARTED"))))))), .{gtd.*.ses.*.input.*.edit_name, ntos(edit.*.used), ntos(filesize), str1});
    if (@as(c_int, gtd.*.ses.*.input.*.edit_name.*) != 0) {
        _ = check_all_events(gtd.*.ses, @as(c_int, 1) << @intCast(@as(c_int, 6)), 1, 4, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("EDIT STARTED %s"))))))), .{gtd.*.ses.*.input.*.edit_name, gtd.*.ses.*.input.*.edit_name, ntos(edit.*.used), ntos(filesize), str1});
    }
    cursor_redraw_edit(gtd.*.ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
}
pub export fn delete_editor(arg_edit: [*c]struct_edit_data) void {
    var edit = arg_edit;
    _ = &edit;
    if (@as(?*anyopaque, @ptrCast(@alignCast(edit))) == @as(?*anyopaque, null)) {
        tintin_printf2(gtd.*.ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("destroy_edit: NULL"))))))), .{});
        return;
    }
    clear_editor(edit);
    free(@ptrCast(@alignCast(edit)));
}
pub export fn resize_editor(arg_edit: [*c]struct_edit_data, arg_size: c_int) void {
    var edit = arg_edit;
    _ = &edit;
    var size = arg_size;
    _ = &size;
    if (edit.*.size < size) {
        edit.*.size = size;
        edit.*.line = @ptrCast(@alignCast(realloc(@ptrCast(@alignCast(edit.*.line)), @as(c_ulong, @bitCast(@as(c_long, edit.*.size))) *% @sizeOf([*c]struct_row_data))));
    }
}
pub export fn clear_editor(arg_edit: [*c]struct_edit_data) void {
    var edit = arg_edit;
    _ = &edit;
    var index_1: c_int = undefined;
    _ = &index_1;
    edit.*.update = 0;
    {
        index_1 = edit.*.used - @as(c_int, 1);
        while (index_1 >= @as(c_int, 0)) : (index_1 -= 1) {
            delete_line(edit, index_1);
        }
    }
}
pub export fn str_save_editor(arg_edit: [*c]struct_edit_data, arg_str: [*c][*c]u8) c_int {
    var edit = arg_edit;
    _ = &edit;
    var str = arg_str;
    _ = &str;
    ...
    _ = &size;
    size = 0;
    _ = str_cpy(str, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
    {
        index_1 = 0;
        while (index_1 < edit.*.used) : (index_1 += 1) {
            _ = str_cat_printf(str, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("%s\n"))))))), edit.*.line[@bitCast(@as(isize, @intCast(index_1)))].*.str);
            size += str_len(edit.*.line[@bitCast(@as(isize, @intCast(index_1)))].*.str);
        }
    }
    return size;
}
pub export fn var_save_editor(arg_edit: [*c]struct_edit_data, arg_str: [*c][*c]u8) c_int {
    var edit = arg_edit;
    _ = &edit;
    var str = arg_str;
    _ = &str;
    ...
    size = 0;
    {
        index_1 = 0;
        while (index_1 < edit.*.used) : (index_1 += 1) {
            _ = str_cat_printf(str, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("{%d}{%s}"))))))), index_1 + @as(c_int, 1), edit.*.line[@bitCast(@as(isize, @intCast(index_1)))].*.str);
        }
    }
    return size;
}
pub export fn create_line(arg_edit: [*c]struct_edit_data, arg_index_1: c_int, arg_str: [*c]u8) void {
    var edit = arg_edit;
    _ = &edit;
    ...
    var str = arg_str;
    _ = &str;
    resize_editor(edit, index_1 + @as(c_int, 2));
    edit.*.line[@bitCast(@as(isize, @intCast(index_1)))] = @ptrCast(@alignCast(calloc(1, @sizeOf(struct_row_data))));
    edit.*.line[@bitCast(@as(isize, @intCast(index_1)))].*.str = str_dup(str);
    edit.*.used += 1;
}
pub export fn delete_line(arg_edit: [*c]struct_edit_data, arg_index_1: c_int) void {
    var edit = arg_edit;
    _ = &edit;
    var index_1 = arg_index_1;
    _ = &index_1;
    str_free(edit.*.line[@bitCast(@as(isize, @intCast(index_1)))].*.str);
    free(@ptrCast(@alignCast(edit.*.line[@bitCast(@as(isize, @intCast(index_1)))])));
    edit.*.used -= 1;
}
pub export fn insert_line(arg_edit: [*c]struct_edit_data, arg_index_1: c_int, arg_str: [*c]u8) void {
    var edit = arg_edit;
    _ = &edit;
    var index_1 = arg_index_1;
    _ = &index_1;
    ...
    var cnt: c_int = undefined;
    _ = &cnt;
    if (index_1 >= edit.*.used) {
        while (edit.*.used < index_1) {
            create_line(edit, edit.*.used, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))));
        }
        create_line(edit, edit.*.used, str);
        return;
    }
    resize_editor(edit, edit.*.used + @as(c_int, 2));
    {
        cnt = edit.*.used;
        while (cnt > index_1) : (cnt -= 1) {
            edit.*.line[@bitCast(@as(isize, @intCast(cnt)))] = edit.*.line[@bitCast(@as(isize, @intCast(cnt - @as(c_int, 1))))];
        }
    }
    create_line(edit, index_1, str);
}
pub export fn remove_line(arg_edit: [*c]struct_edit_data, arg_index_1: c_int) void {
    var edit = arg_edit;
    _ = &edit;
    var index_1 = arg_index_1;
    _ = &index_1;
