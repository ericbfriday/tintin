...
#if 0
// --- Extracted add_nest_node from src/nest.c ---
...
#if 0
// --- Extracted add_nest_node_ses from src/nest.c ---
...
#if 0
// --- Extracted command from src/command.c ---
...
#if 0
// --- Extracted execute from src/command.c ---
...
#if 0
// --- Extracted set_nest_node from src/nest.c ---
...
#if 0
// --- Extracted set_nest_node_ses from src/nest.c ---
