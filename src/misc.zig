...
pub const do_line = tintin_c.do_line;
...
pub const fmemopen = tintin_c.fmemopen;
...
pub const is_math = tintin_c.is_math;
pub const off_t = tintin_c.off_t;
pub const pcre2_code_8 = tintin_c.pcre2_code_8;
pub const pop_call = tintin_c.pop_call;
pub const printf = tintin_c.printf;
pub const push_call = tintin_c.push_call;
pub const quitmsg = tintin_c.quitmsg;
pub const read_file = tintin_c.read_file;
...
pub export fn do_end(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8, arg_arg3: [*c]u8, arg_arg4: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    _ = &arg4;
    if (@as(c_int, arg.*) != 0) {
        _ = sub_arg_in_braces(ses, arg, arg1, GET_ALL, ((((@as(c_int, 1) << @intCast(@as(c_int, 4))) | (@as(c_int, 1) << @intCast(@as(c_int, 5)))) | (@as(c_int, 1) << @intCast(@as(c_int, 6)))) | (@as(c_int, 1) << @intCast(@as(c_int, 7)))) | (@as(c_int, 1) << @intCast(@as(c_int, 9))));
        quitmsg(arg1);
    } else {
        quitmsg(null);
    }
...
pub export fn do_nop(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8, arg_arg3: [*c]u8, arg_arg4: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
...
pub export fn do_test(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8, arg_arg3: [*c]u8, arg_arg4: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    var arg = arg_arg;
    const arg1 = arg_arg1;
    const arg2 = arg_arg2;
    ...
    if (strcmp(arg1, @as([*c]const u8, @ptrCast("pointers"))) == 0) {
        var data: u8 = 'X';
        var test_ptr: [*c]u8 = @ptrCast(&data);
        const idx: c_ulong = @intCast(@intFromPtr(test_ptr));

        _ = printf("data %c index %lu test %c\n", data, idx, test_ptr[0]);

        test_ptr = null;
        _ = printf("data %c index %lu test %c\n", data, idx, test_ptr[idx]);
    }

    if (strcmp(arg1, @as([*c]const u8, @ptrCast("gmcp"))) == 0) {
        _ = execute(ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("%s"))))))))), @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#event {IAC SB GMCP} {#var {%0} {%1};#line debug #var {%0}}"))))))))));
        test_gmcp(ses, @as([*c]u8, @ptrCast(@constCast("Char.Defences.List [ { \"name\": \"boar tattoo\", \"desc\": \"boar tattoo\" }, { \"name\": \"moss tattoo\", \"desc\": \"moss tattoo\" } ]"))));
        test_gmcp(ses, @as([*c]u8, @ptrCast(@constCast("MG.room.info { \"exits\": [ ], \"short\": \"Dschungel.\", \"id\": \"1\"}"))));
        test_gmcp(ses, @as([*c]u8, @ptrCast(@constCast("char.combat_immunity {\"combat_immunity\": \"a tame dragon is immune to your attack\"}"))));
        test_gmcp(ses, @as([*c]u8, @ptrCast(@constCast("room.info { \"num\": 5922, \"name\": \"At the entrance of the park\", \"zone\": \"zoo\", \"terrain\": \"city\", \"exits\": { \"e\": 5920, \"s\": 5916, \"w\": 12611 }, \"coord\": { \"id\": 0, \"x\": 37, \"y\": 19, \"cont\": 0 } }"))));
    }

    if (strcmp(arg1, @as([*c]const u8, @ptrCast("bla"))) == 0) {
        const a: c_int = 1;
        var b: c_int = 0;
        // avoid compile time panic
        if (arg[0] == 'b') b = 1;
        const c: c_int = @divTrunc(a, b);

        _ = printf("%d", c);
        tintin_printf(ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("len: %d"))))))))), strip_color_strlen(ses, arg));
    }

    if (strcmp(arg1, @as([*c]const u8, @ptrCast("rain"))) == 0) {
        _ = strcpy(arg2, @as([*c]const u8, @ptrCast("9")));
        _ = strcpy(arg3, @as([*c]const u8, @ptrCast("<f3c3>")));
        _ = strcpy(arg1, @as([*c]const u8, @ptrCast("1 9")));

        if (is_digit(arg[0]) != 0) {
            _ = sprintf(arg2, "%d", (arg[0] - '0') * (arg[0] - '0'));

            if ((is_hex(arg[1]) != 0 and is_hex(arg[2]) != 0 and is_hex(arg[3]) != 0) or (arg[1] == '?' and arg[2] == '?' and arg[3] == '?')) {
                _ = sprintf(arg3, "<f%c%c%c>", arg[1], arg[2], arg[3]);

                if (is_digit(arg[4]) != 0 and is_digit(arg[5]) != 0) {
                    _ = sprintf(arg1, "%f %d %s", @as(f64, @floatFromInt((arg[4] - '0') * (arg[4] - '0'))) / 10.0, (arg[5] - '0') * (arg[5] - '0'), &arg[6]);
                }
            }
        }
        _ = command(tintin_c.gtd.*.ses, do_line, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("quiet {#event {RECEIVED KEYPRESS} {#end \\};#screen cursor hide;#screen clear all;#event {SECOND} #loop 0 %s cnt #delay {$cnt / (1.0+%s)} #draw %s rain 1 1 -1 -1 rain %s}"))))))))), arg2, arg2, arg3, arg1);
        return ses;
    }

    if (strcmp(arg1, @as([*c]const u8, @ptrCast("gui"))) == 0) {
        var data: [BUFFER_SIZE]u8 = undefined;
        _ = strcpy(@as([*c]u8, @ptrCast(&data)), tt_gui);
        const len = strlen(@as([*c]const u8, @ptrCast(&data)));
        const file = fmemopen(@as([*c]u8, @ptrCast(&data)), len, @as([*c]const u8, @ptrCast("r")));
        tintin_c.gtd.*.level.*.quiet += 1;
        ses = read_file(ses, file, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("tt_gui.h"))))))))));
        tintin_c.gtd.*.level.*.quiet -= 1;
        _ = fclose(file);
        return ses;
    }

    if (strcmp(arg1, @as([*c]const u8, @ptrCast("regex"))) == 0) {
        var data: [BUFFER_SIZE]u8 = undefined;
        _ = strcpy(@as([*c]u8, @ptrCast(&data)), tt_regex);
        const len = strlen(@as([*c]const u8, @ptrCast(&data)));
        const file = fmemopen(@as([*c]u8, @ptrCast(&data)), len, @as([*c]const u8, @ptrCast("r")));
        tintin_c.gtd.*.level.*.quiet += 1;
        ses = read_file(ses, file, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("tt_regex.h"))))))))));
        tintin_c.gtd.*.level.*.quiet -= 1;
        _ = fclose(file);
        return ses;
    }

    if (strcmp(arg1, @as([*c]const u8, @ptrCast("prompt"))) == 0) {
        ses.*.telopts |= TELOPT_FLAG_PROMPT;
        ses.*.config_flags |= CONFIG_FLAG_AUTOPROMPT;
        return ses;
    }
...
pub export fn do_bell(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8, arg_arg3: [*c]u8, arg_arg4: [*c]u8) [*c]struct_session {
    ...
    if (@as(c_int, arg1.*) == @as(c_int, 0)) {
        print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x07"))))))));
    } else if (is_abbrev(arg1, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("FLASH")))))))) != 0) {
        if (is_abbrev(arg2, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("ON")))))))) != 0) {
            print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x1b[?1042h"))))))));
        } else if (is_abbrev(arg2, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("OFF")))))))) != 0) {
            print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x1b[?1042l"))))))));
        } else {
            show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#SYNTAX: #BELL FLASH {ON|OFF}"))))))));
        }
    } else if (is_abbrev(arg1, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("FOCUS")))))))) != 0) {
        if (is_abbrev(arg2, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("ON")))))))) != 0) {
            print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x1b[?1043h"))))))));
        } else if (is_abbrev(arg2, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("OFF")))))))) != 0) {
            print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x1b[?1043l"))))))));
        } else {
            show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#SYNTAX: #BELL FOCUS {ON|OFF}"))))))));
        }
    } else if (is_abbrev(arg1, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("MARGIN")))))))) != 0) {
        if (is_abbrev(arg2, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("ON")))))))) != 0) {
            print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x1b[?44h"))))))));
        } else if (is_abbrev(arg2, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("OFF")))))))) != 0) {
            print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x1b[?44l"))))))));
        } else {
            show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#SYNTAX: #BELL MARGIN {ON|OFF}"))))))));
        }
    } else if (is_abbrev(arg1, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("RING")))))))) != 0) {
        print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x07"))))))));
    } else if (is_abbrev(arg1, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("VOLUME")))))))) != 0) {
        if (is_math(ses, arg2) != 0) {
            print_stdout(0, 0, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("\x1b[ %dt"))))))), @as(c_int, @intFromFloat(get_number(ses, arg2))));
        } else {
            show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#SYNTAX: #BELL VOLUME {1-8}"))))))));
        }
    } else {
        show_error(ses, LIST_COMMAND, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("#SYNTAX: #BELL {FLASH|FOCUS|MARGIN|RING|VOLUME} {ARGUMENT}"))))))));
    }
    return ses;
}
pub export fn do_cr(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8, arg_arg3: [*c]u8, arg_arg4: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    var arg4 = arg_arg4;
    _ = &arg4;
    write_mud(ses, @as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast(""))))))), @as(c_int, 1) << @intCast(@as(c_int, 8)));
    return ses;
}
pub export fn do_send(arg_ses: [*c]struct_session, arg_arg: [*c]u8, arg_arg1: [*c]u8, arg_arg2: [*c]u8, arg_arg3: [*c]u8, arg_arg4: [*c]u8) [*c]struct_session {
    var ses = arg_ses;
    _ = &ses;
    var arg = arg_arg;
    _ = &arg;
    ...
    var arg4 = arg_arg4;
    _ = &arg4;
    push_call(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@as([*c]u8, @ptrCast(@constCast("do_send(%p,%p)"))))))), ses, arg);
    _ = get_arg_in_braces(ses, arg, arg1, GET_ALL);
    write_mud(ses, arg1, (((@as(c_int, 1) << @intCast(@as(c_int, 4))) | (@as(c_int, 1) << @intCast(@as(c_int, 5)))) | (@as(c_int, 1) << @intCast(@as(c_int, 7)))) | (@as(c_int, 1) << @intCast(@as(c_int, 8))));
    pop_call();
    return ses;
}
